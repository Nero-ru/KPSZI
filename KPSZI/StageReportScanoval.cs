...
namespace KPSZI
{
    ...
    {
        protected override Button BtnExportToWord { get => mf.btnExportToWord_Scanoval; }
        protected override Encoding htmlEncoding { get => Encoding.UTF8; }

        public StageReportScanoval(TabPage stageTab, TreeNode stageNode, MainForm mainForm, InformationSystem IS, string template, WebBrowser wb)
        ...
        public override void ReportToWord(string pathHTML, string nameWord, bool groupExport = false, Word.Document doc = null, Word.Application app = null, Word.Paragraph paragraph = null)
        {
            ...
            HtmlTableElement[][][] tables = new HtmlTableElement[reportNodes.Count][][];
            ...
            #region Таблица №3
            FillRangeInWord(paragraph.Range, htmlDoc.DocumentNode.SelectNodes("/html/body/div/div[3]/div")[0].InnerText, "Times New Roman", 14, 0, Word.WdParagraphAlignment.wdAlignParagraphLeft, Word.WdColor.wdColorBlack);
            table.Spacing = 6;
            paragraph.Range.InsertParagraphAfter();
            ...
            #region Таблица №4
            FillRangeInWord(paragraph.Range, htmlDoc.DocumentNode.SelectNodes("/html/body/div/div[4]/div")[0].InnerText, "Times New Roman", 14, 0, Word.WdParagraphAlignment.wdAlignParagraphLeft, Word.WdColor.wdColorBlack);
